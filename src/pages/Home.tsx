          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-lg bg-card border border-border hover:border-primary transition-colors">
              ...
              <p className="text-muted-foreground">
                Pushing boundaries by reconsidering the objective function that we are solving for
              </p>
            </div>
            <div className="p-8 rounded-lg bg-card border border-border hover:border-primary transition-colors">
            ...
            <div className="p-8 rounded-lg bg-card border border-border hover:border-primary transition-colors">
              ...
              <p className="text-muted-foreground">
                Committed to delivering improvements in human flourishing - leave no man or woman where you found them
              </p>
            </div>
          </div>
        </section>
