      ...
      <main className="pt-32 pb-20 container mx-auto px-6">
        ...
        <div className="max-w-3xl space-y-8">
          <section>
            ...
            <p className="text-muted-foreground text-lg">We fight for the user. This was our first and only rallying cry. We took early inspiration from the inherent promises of invisible computing and human-centric design ethics. We think it's time to bring this back, with vengeance.</p>
          </section>
